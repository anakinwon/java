package com.pisien.edu.pro.pro05Collection02.example08;
...
public class TreeMapSearchEx {
	...
	public static void main(String[] args) {
		...
		//c부터 f까지만 검색하기, f이후에 값이 있는 검색안된다.
		...
		System.out.println("[d포함 이후 단어 검색하기]");
		...
		System.out.println("[g포함 이전 단어 검색하기]");
