package com.pisien.edu.pro.pro04Collection01.example04;
...
public class ArrayListLinkedListEx_Access {
	...
	public static void main(String[] args) {
		...
		System.out.println("LinkedList : " + access(linkeList));
...
//	ArrayList가 성능이 우수한 반면에 중간에 삽입, 삭제는 LinkedList가
//	확연하게 빠르다는 것을 알 수가 있다.
}
